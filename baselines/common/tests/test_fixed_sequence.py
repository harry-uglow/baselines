...
learn_kwargs = {
    u'a2c': {},
    u'ppo2': dict(nsteps=10, ent_coef=0.0, nminibatches=1),
...
@pytest.mark.slow
@pytest.mark.parametrize(u"alg", alg_list)
@pytest.mark.parametrize(u"rnn", rnn_list)
...
if __name__ == u'__main__':
    test_fixed_sequence(u'ppo2', u'lstm')
